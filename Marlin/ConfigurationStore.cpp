...
SERIAL_ECHOLNPGM("Scaling factors:");
    ...
    SERIAL_ECHOLN(""); 
	 ...
	 SERIAL_ECHOPAIR(", L_REMOVE: " ,(unsigned long)remove_temp_l);
	 SERIAL_ECHOPAIR(", L_BED: " ,(unsigned long)bed_temp_l);
	 SERIAL_ECHOPAIR(", L_PRINT: " ,(unsigned long)print_temp_l);
	 SERIAL_ECHOLN("");
	 ...
	 SERIAL_ECHOPAIR(", R_REMOVE: " ,(unsigned long)remove_temp_r);
	 SERIAL_ECHOPAIR(", R_BED: " ,(unsigned long)bed_temp_r);
	 SERIAL_ECHOPAIR(", R_PRINT: " ,(unsigned long)print_temp_r);
	 SERIAL_ECHOLN("");
	 ...
	 SERIAL_ECHOPAIR(", hours print: " ,(unsigned long)log_hours_print);
	 SERIAL_ECHOPAIR(", prints finished: " ,(unsigned long)log_prints_finished);
	 SERIAL_ECHOPAIR(", max temp L: " ,(unsigned long)log_max_temp_l);
	 SERIAL_ECHOPAIR(", max temp R: " ,(unsigned long)log_max_temp_r);
	 SERIAL_ECHOPAIR(", max temp B: " ,(unsigned long)log_max_bed);
	 SERIAL_ECHOLN("");
